...
ADD ./files/sensu-enterprise.repo ./files/sensu-enterprise-dashboard.repo /etc/yum.repos.d/
RUN yum install -y sensu-enterpise
...
# Enterpise Dashboard
RUN yum install sensu-enterprise-dashboard
ADD ./files/dashboard.json /etc/sensu/
